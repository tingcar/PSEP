...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_profile', (
            ...
            ('Chinese_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('is_activate', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('Distription', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
